...
def run_switch_threshold_tests(video_path: str, mask_path: str, prompt: str, 
    ...
    for i, switch_threshold in enumerate(threshold_values, 1):
        ...
        print(f"📊 Switch Threshold: {switch_threshold} (matching timestep scale 0-1000)")
        ...
        try:
            ...
            output_path = orchestrator.generate_vace(
                ...
                switch_threshold=switch_threshold,  # 🎯 KEY TEST PARAMETER - Keep in 0-1000 range to match timesteps
